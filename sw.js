const CACHE_NAME='allin-v5.2.0';
const APP_SHELL=['./','./index.html','./admin.html','./styles.css?v=5.2.0','./config.js?v=5.2.0','./common.js?v=5.2.0','./member.js?v=5.2.0','./admin.js?v=5.2.0','./allin-manifest-v520.webmanifest','./allin-logo.png','./allin-app-icon-192-v503.png','./allin-app-icon-512-v503.png'];
