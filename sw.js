const CACHE_NAME='allin-v5.3.2';
const APP_SHELL=['./','./index.html','./admin.html','./styles.css?v=5.3.2','./config.js?v=5.3.2','./common.js?v=5.3.2','./member.js?v=5.3.2','./admin.js?v=5.3.2','./allin-manifest-v530.webmanifest','./allin-logo.png','./allin-app-icon-192-v503.png','./allin-app-icon-512-v503.png'];
