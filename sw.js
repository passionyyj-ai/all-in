const CACHE_NAME='allin-v5.6.1';
const APP_SHELL=[
 './','./index.html','./admin.html','./operation.html',
 './styles.css?v=5.6.1','./config.js?v=5.6.1','./common.js?v=5.6.1',
 './member.js?v=5.6.1','./admin.js?v=5.6.1','./operation.js?v=5.6.1',
 './manifest-member.webmanifest?v=5.6.1','./manifest-admin.webmanifest?v=5.6.1',
